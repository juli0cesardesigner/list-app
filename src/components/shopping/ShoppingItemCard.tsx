    ...
    >
      <div className="bg-[#1c1c1e]/80 backdrop-blur-2xl border border-white/10 rounded-[22px] p-4 shadow-2xl flex items-center justify-between transition-all active:scale-[0.98] active:bg-[#2c2c2e]/90">
        ...
        >
          ...
          <div className="w-7 h-7 rounded-full border-2 border-blue-500/50 flex items-center justify-center transition-all hover:border-blue-500 hover:bg-blue-500/10 flex-shrink-0">
          ...
          <div className="flex flex-col overflow-hidden">
            ...
            {parsed.alternatives.length > 0 && (
              <div className="flex items-center gap-1.5 mt-1 overflow-hidden">
                <span className="text-[9px] font-black text-zinc-500 uppercase tracking-tighter bg-zinc-800/50 px-1.5 py-0.5 rounded-md flex-shrink-0">
                  ou
                </span>
